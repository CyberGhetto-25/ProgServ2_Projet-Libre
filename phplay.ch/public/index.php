...
try {
    ...
    $mail->addAddress('tonemail@gmail.com', 'Moi');
 
    $mail->isHTML(true);
    $mail->Subject = 'Test PHPMailer';
    $mail->Body    = '<b>Félicitations !</b> Votre configuration SMTP fonctionne.';
    $mail->AltBody = 'Félicitations ! Votre configuration SMTP fonctionne.';
